...
Hardware:
  ...
  1 x Potentiometer (uses internal accelerometer, microphone, buttons A & B and slide switch
                     and onboard neoPixels)
  1 x 38 LED WS2812B strip
*/
...
////NeoPixel strip connected to A7
#define DATA_PIN 1
...
#define POT_PIN  A3        //Otherwise known as pin 10?
...
void setup(){
    ...
    FastLED.show();
    //used by the fire_effect() function, sets a (bulit in) palette for the funciton to use
    gPal = HeatColors_p;
    boot_sequence();
}
